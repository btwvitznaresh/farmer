...
export const translations = {
  ...
  services: {
    en: {
      ...
      urgentUrgency: "Urgent (+₹200)",
      upcomingBookings: "Upcoming",
      pastBookings: "Past",
      noBookings: "No bookings yet",
      cancelBooking: "Cancel Booking",
      viewReport: "View Report",
      teamOnWay: "Team on the way",
      whatsIncluded: "What's included",
    },
    hi: {
      title: "हमारी सेवाएँ",
      subtitle: "हम आपके खेत आते हैं",
    ...
    ta: {
      ...
      farmLocation: "உங்கள் பண்ணையின் இடம்",
      specialInstructions: "சிறப்பு வழிமுறைகள் (விருப்பத்தேர்வு)",
      normalUrgency: "சாதாரண",
      urgentUrgency: "அவசரம் (+₹200)",
      upcomingBookings: "வரவிருக்கும்",
      pastBookings: "கடந்த",
      noBookings: "பதிவுகள் எதுவும் இல்லை",
      cancelBooking: "பதிவை ரத்து செய்",
      viewReport: "அறிக்கையைக் காண்க",
      teamOnWay: "குழு வந்து கொண்டிருக்கிறது",
      whatsIncluded: "இதில் அடங்குபவை",
    },
    te: {
      title: "మా సేవలు",
      subtitle: "మేము మీ పొలానికి వస్తాము",
      bookNow: "ఇప్పుడే బుక్ చేయండి",
      bookingConfirmed: "బుకింగ్ నిర్ధారించబడింది!",
      selectDate: "తేదీ ఎంచుకోండి",
      selectTime: "సమయం ఎంచుకోండి",
      farmLocation: "మీ పొలం స్థలం",
      specialInstructions: "ప్రత్యేక సూచనలు (ఐచ్ఛికం)",
      normalUrgency: "సాధారణ",
      urgentUrgency: "అత్యవసరం (+₹200)",
      upcomingBookings: "రాబోయేవి",
      pastBookings: "గతవి",
      noBookings: "బుకింగ్‌లు లేవు",
      cancelBooking: "బుకింగ్ రద్దు చేయండి",
      viewReport: "రిపోర్ట్ చూడండి",
      teamOnWay: "బృందం దారిలో ఉంది",
      whatsIncluded: "ఇందులో ఉన్నవి",
    },
    mr: {
      title: "आमच्या सेवा",
      subtitle: "आम्ही तुमच्या शेतात येतो",
      bookNow: "आता बुक करा",
      bookingConfirmed: "बुकिंग निश्चित झाले!",
      selectDate: "तारीख निवडा",
      selectTime: "वेळ निवडा",
      farmLocation: "तुमच्या शेताचे ठिकाण",
      specialInstructions: "विशेष सूचना (ऐच्छिक)",
      normalUrgency: "सामान्य",
      urgentUrgency: "तातडीचे (+₹200)",
      upcomingBookings: "येणारे",
      pastBookings: "मागील",
      noBookings: "अद्याप बुकिंग नाही",
      cancelBooking: "बुकिंग रद्द करा",
      viewReport: "अहवाल पहा",
      teamOnWay: "टीम येत आहे",
